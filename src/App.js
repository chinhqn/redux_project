...
class App extends Component {
    ...
    chang = () => {
        if (this.state.isDisplayForm && this.state.isTaskUpdate !== null) {
            this.setState({isDisplayForm: true, isTaskUpdate: null});
        } else {
            this.setState({
    ...
    onResubmit = (data) => {
        ...
        this.setState({tasks: tasks, isTaskUpdate: null});
    ...
    onUpdate = (id) => {
        ...
        this.setState({isTaskUpdate: isTaskUpdate});
        this.onShowForm();
    };
    ...
    render() {
        ...
        var elmTaskForm = isDisplayForm
            ? <Taskform
                    ...
                    task={isTaskUpdate}/>
            : '';
        var changColLg = isDisplayForm
            ? 'col-xs-8 col-sm-8 col-md-8 col-lg-8'
            : 'col-xs-12 col-sm-12 col-md-12 col-lg-12';
        var changColSm = isDisplayForm
